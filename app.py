...
- Include at least 16 fixtures in fixtures array
- Detailed analysis per slip (4-6 bullet points)
"""
    headers = {
        "x-api-key": api_key,
    ...
    body = {
        ...
        "max_tokens": 16000,  # FIX: increased from 8000 to prevent truncated JSON
